...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/users/**").access("hasAnyAuthority('ADMIN', 'GERENTE')")
                .antMatchers("/barbers/**").access("hasAnyAuthority('ADMIN', 'GERENTE')")
                .antMatchers("/cuts/**").access("hasAnyAuthority('ADMIN', 'GERENTE')")
                .antMatchers("/scheduleReport/**").access("hasAnyAuthority('ADMIN', 'GERENTE')")
                .antMatchers("/userForm/**").permitAll()
                .antMatchers("/uerForm/register").permitAll()
                ...
                .and().formLogin().loginPage("/login?successRegister").permitAll()
